...
function WellTable() {
    ...
    const { allWells, filteredWells, setFilterField, setFilterCluster, setFilterWell, filterField, filterCluster, filterWell } = useWellData(data)
            ...
            <Table stickyHeader>
                <TableHead>
                    <TableRow>
                        ...
                        <TableCell className={s.headerCell}>Наряжение</TableCell>
                ...
                <TableBody>
                    ...
                    {virtualRows.length > 0 && (
                        <TableRow className={s.spacerRow} style={{ height: `${totalSize - virtualRows[virtualRows.length - 1].end}px`}}>
