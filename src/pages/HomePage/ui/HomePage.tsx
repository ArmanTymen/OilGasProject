    ...
    <main className={s.root}>
        ...
        {[1, 2, 3].map((i) => (
          <Paper key={i} sx={{ p: 3, borderLeft: '5px solid #ccc' }}>
            <Typography variant="subtitle2" color="text.secondary">
              {i === 1 ? 'TODO: Суммарный дебит' : i === 2 ? 'TODO: Фонд в работе' : 'TODO: Аварийность'}
            </Typography>
      ...
      <div className={s.contentLayout}>
        ...
        <section className={s.mainChart}>
          <Paper sx={{ p: 3, height: 400, display: 'flex', alignItems: 'center', justifyContent: 'center', bgcolor: '#f9f9f9', border: '2px dashed #ddd' }}>
            <Box textAlign="center">
              <Typography variant="h6" color="text.secondary">ГРАФИК ДОБЫЧИ / КАРТА</Typography>
              <Typography variant="body2" color="text.disabled">Использовать Recharts для трендов или Leaflet для ГИС</Typography>
            </Box>
          </Paper>
        </section>
        ...
        <aside className={s.alertsAside}>
          <Typography variant="h6" gutterBottom>Последние алерты</Typography>
